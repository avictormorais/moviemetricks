...
import { FaStar, FaCalendarDay, FaFacebookF, FaInstagram, FaTiktok, FaXTwitter, FaYoutube } from 'react-icons/fa6';
      ...
      {content ? (
        <div>
          <div className={styles.divInfosPerson}>
            <img src={`https://image.tmdb.org/t/p/w300/${content.profile_path}`} alt="" />
